...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.WynTable.horizontalHeader().setResizeMode(1, QtGui.QHeaderView.ResizeToContents)
        self.WynTable.setHorizontalHeaderItem(1, item)
        self.WynTable.horizontalHeader().setStretchLastSection(True)
        self.WholeWordSwitch = QtGui.QCheckBox(self.centralwidget)
        self.WholeWordSwitch.setGeometry(QtCore.QRect(660, 170, 101, 20))
        self.WholeWordSwitch.setObjectName(_fromUtf8("WholeWordSwitch"))
        self.lineEdit = QtGui.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(640, 30, 471, 31))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.CaseSwitch = QtGui.QCheckBox(self.centralwidget)
        self.CaseSwitch.setGeometry(QtCore.QRect(660, 230, 221, 20))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(640, 100, 371, 31))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.closeButton = QtGui.QPushButton(self.centralwidget)
        self.closeButton.setGeometry(QtCore.QRect(1030, 280, 93, 28))
        self.closeButton.setObjectName(_fromUtf8("closeButton"))
        self.SearchButt = QtGui.QPushButton(self.centralwidget)
        self.SearchButt.setGeometry(QtCore.QRect(910, 280, 93, 28))
        self.SearchButt.setObjectName(_fromUtf8("SearchButt"))
        self.RexExSwitch = QtGui.QCheckBox(self.centralwidget)
        self.RexExSwitch.setGeometry(QtCore.QRect(660, 200, 151, 20))
        self.RexExSwitch.setObjectName(_fromUtf8("RexExSwitch"))
        self.label_2 = QtGui.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(640, 80, 101, 16))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.pushButton = QtGui.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(1130, 30, 31, 31))
